...
| `calculate_b_field` | Calculates the magnetic field generated by a coil. | `coil_instance` (Coil): An instance of a Coil subclass.<br>`field_points` (np.ndarray or np.ndarray of mtf): The points where the magnetic field should be calculated.<br>`backend` (str, optional): The backend to use for the calculation. | `Bfield`: A `Bfield` object containing the calculated magnetic field. |
