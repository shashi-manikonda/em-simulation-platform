...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join(
            "/home/manikonda/work/em-simulation-platform/demos/runoutput/straight_wire_demo",
            filename,
        )
...
try:
    exec(
        open(
            r"/home/manikonda/work/em-simulation-platform/demos/em/straight_wire_demo.py"
        ).read()
    )
