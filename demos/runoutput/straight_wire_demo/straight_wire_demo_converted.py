...
# %%
import numpy as np
from em_app.currentcoils import _straight_wire_segments
from em_app.biot_savart import serial_biot_savart
...
segment_centers, segment_lengths, segment_directions = _straight_wire_segments(start_point, end_point, num_segments)

observation_point = np.array([[0.1, 0, 0]])
B_vectors = serial_biot_savart(segment_centers, segment_lengths, segment_directions, observation_point)
B_numerical = B_vectors[0] * current
