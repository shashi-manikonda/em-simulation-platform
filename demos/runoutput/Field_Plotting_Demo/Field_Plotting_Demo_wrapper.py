...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join(
            "/home/manikonda/work/em-simulation-platform/demos/runoutput/Field_Plotting_Demo",
            filename,
        )
...
try:
    exec(
        open(
            r"/home/manikonda/work/em-simulation-platform/demos/em/Field_Plotting_Demo.py"
        ).read()
    )
