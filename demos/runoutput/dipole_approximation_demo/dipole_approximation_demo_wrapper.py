...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join("/home/manikonda/work/MTFLibrary/demos/runoutput/dipole_approximation_demo", filename)
...
try:
    exec(open(r"/home/manikonda/work/MTFLibrary/demos/em/dipole_approximation_demo.py").read())
