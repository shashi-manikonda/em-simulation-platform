...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join(
            "/home/manikonda/work/em-simulation-platform/demos/runoutput/dipole_approximation_demo",
            filename,
        )
...
try:
    exec(
        open(
            r"/home/manikonda/work/em-simulation-platform/demos/em/dipole_approximation_demo.py"
        ).read()
    )
