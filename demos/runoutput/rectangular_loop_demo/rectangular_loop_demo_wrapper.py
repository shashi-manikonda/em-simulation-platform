...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        # Create filename
        filename = f"rectangular_loop_demo_fig{_figure_counter:03d}.png"
        filepath = os.path.join("/home/manikonda/work/MTFLibrary/demos/runoutput/rectangular_loop_demo", filename)
...
try:
    exec(open(r"/home/manikonda/work/MTFLibrary/demos/em/rectangular_loop_demo.py").read())
