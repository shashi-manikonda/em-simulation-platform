...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join(
            "/home/manikonda/work/em-simulation-platform/demos/runoutput/rectangular_loop_demo",
            filename,
        )
...
try:
    exec(
        open(
            r"/home/manikonda/work/em-simulation-platform/demos/em/rectangular_loop_demo.py"
        ).read()
    )
