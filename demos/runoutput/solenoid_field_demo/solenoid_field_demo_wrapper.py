...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        # Create filename
        filename = f"solenoid_field_demo_fig{_figure_counter:03d}.png"
        filepath = os.path.join("/home/manikonda/work/MTFLibrary/demos/runoutput/solenoid_field_demo", filename)
...
try:
    exec(open(r"/home/manikonda/work/MTFLibrary/demos/em/solenoid_field_demo.py").read())
