...
def save_figure_as_png(*args, **kwargs):
    ...
    if fig.get_axes():
        ...
        filepath = os.path.join(
            "/home/manikonda/work/em-simulation-platform/demos/runoutput/solenoid_field_demo",
            filename,
        )
...
try:
    exec(
        open(
            r"/home/manikonda/work/em-simulation-platform/demos/em/solenoid_field_demo.py"
        ).read()
    )
